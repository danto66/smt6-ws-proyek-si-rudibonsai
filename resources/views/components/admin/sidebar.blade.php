    ...
    <nav class="mt-10">
        ...
        <div x-data="{produkOpen : false}">
            <button x-on:click="produkOpen=true"
                class="flex justify-between w-full mt-4 py-2 px-6 admin-sidebar-item admin-sidebar-item-hover {{ request()->routeIs('adminproducts*') || request()->routeIs('admin.categories*') ? 'admin-sidebar-item-active' : '' }}"
                href="/tables">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
