...
@section('content')
    ...
    <div x-data="{modalCategoryShow:false, inputCategoryValue:null, inputCategoryId:null, modalTitle:null}">
        <button x-on:click="modalCategoryShow = true; modalTitle = 'Tambah Kategori'"
            ...
            <div class="fixed z-40 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div
                        ...
                        <form method="POST" action="/admin/categories/3">
                            @method('PUT')
                            @csrf
