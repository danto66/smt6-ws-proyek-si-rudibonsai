                ...
                @else
                    ...
                    <div class="mt-2">
                        ...
                        <div class="mt-2">
                            ...
                            @else
                                <x-alert :status="strtolower($order->status)"
                                    :newMsg="('Ubah status menjadi ') . $nextStatus" />
                            @endif
                        </div>

                        <div>
                            <form method="POST"
                                action="{{ route('admin.order.update_status', ['order' => $order->id]) }}">
                                @method('PUT')
                                @csrf
                                ...
                                @else
                                    ...
                                    <button onclick="return confirm('Ubah status pesanan menjadi {{ $nextStatus }}?')"
                                        type="submit" class="btn-sm btn-green mt-2 w-full">Konfirmasi</button>
                                @endif
                            </form>
                        </div>
                    </div>
